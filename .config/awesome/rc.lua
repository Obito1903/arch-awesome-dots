...
-- If LuaRocks is installed, make sure that packagqes installed through it are
...
terminal = "termite"
-- Default editor
editor = os.getenv("EDITOR") or "code" or "vim"
-- Default term editor
...
KeyboardLayoutIndicator = awful.widget.keyboardlayout()
...
screen.connect_signal("request::desktop_decoration", function(s)
    ...
    s.layoutIndicator = awful.widget.layoutbox {
        screen  = s,
        buttons = {
    ...
    s.taskList = awful.widget.tasklist {
        ...
        buttons = {
            ...
            -- Show the list of opened client
            awful.button({ }, 3, function() awful.menu.client_list { theme = { width = 250 } } end),
            -- Scrool through the client of the tag
...
awful.mouse.append_global_mousebindings({
    awful.button({ }, 3, function () MenuAppLauncher:toggle() end),
